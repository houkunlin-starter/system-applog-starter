...
public class TestAppLogController {
    ...
    public Object testLog1() {
        ...
        APP_LOGGER.log("testLog1 记录普通的日志信息，并且记录参数信息 {}", "这是参数信息");
        return "返回信息";
    }
    ...
    public Object testLog2() {
        ...
        APP_LOGGER.log("testLog2 记录普通的日志信息，并且记录参数信息 {}", "这是参数信息");
        APP_LOGGER.log("testLog2 记录普通的日志信息，并且记录参数信息 {} 和异常信息 {}", "这是参数信息", exception);
    ...
    public Object testLog3() {
        ...
        APP_LOGGER.log("testLog3 记录普通的日志信息，并且记录参数信息 {}", "这是参数信息");
        APP_LOGGER.log("testLog3 第一个参数 {}， 第二个参数是异常 {}，第三个参数 {}，第四个参数是异常 {}", "这是参数信息", exception, "其他信息", exception);
