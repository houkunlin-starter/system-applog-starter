 ...
 * <p>可自行实现 {@link AppLogTemplateParser} 接口来解析字符串模板，默认提供 {@link AppLogTemplateParserDefaultImpl} 来支持 SpEL 模板表达式解析
 * <p>默认支持 SpEL 表达式用法：
 * <ul>
...
public @interface AppLog {
     ...
     *
     * <p>
     * 可自行实现 {@link AppLogTemplateParser} 接口来解析字符串模板，默认提供 {@link AppLogTemplateParserDefaultImpl} 来支持 SpEL 模板表达式解析
     *
     * @return 日志内容
     */
